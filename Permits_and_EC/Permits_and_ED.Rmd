...
dat <- read.csv("Permits.csv", stringsAsFactors = F)

#splitting the dataframe into two: permit types used for analysis and permit types ignored
x <- dat$Type
...
#Electric meter set
  x <- df.I$Type == "Electric (Meter Set)"
plot(shapes) 
  points(df.I[x,], pch=20, cex= .2, col=adjustcolor("red", alpha.f = .6))
