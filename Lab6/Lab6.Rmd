...
syr1 <- syr[as.numeric(as.character(syr$NAME10)) < 64, ] #Cutting all tracks that are not in syracuse. lower than 64 gets this.
par( mar=c(0,0,0,0) )
...
interstate <- gIntersection(syr, interstate)
roads <-gIntersection(syr, roads)
